                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () {
                            ...
                            Navigator.pushNamed(context, RouteNames.followersRoute, arguments: {'userId': userInformation.uid});  
                        ...
                        GestureDetector(
                          onTap : () {
                            ...
                            Navigator.pushNamed(context, RouteNames.followingRoute, arguments: {'userId': userInformation.uid});  
                            // You can navigate to another screen or perform other actions
                          },
                          child: StreamBuilder<DocumentSnapshot>(
                            stream: FirebaseFirestore.instance.collection('Users').doc(userInformation.uid).snapshots(),
